...
CONFIG="${CONFIG:-$PROJECT_ROOT/music_infuser/configs/cat_lora_lite_train50_100step.yaml}"
...
export CAT_LORA_TRAIN_DATA="${CAT_LORA_TRAIN_DATA:-/home/ubuntu/342/hyellim/datasets/musicinfuser/videos_preprocessed_aist_73_train50}"
